...
import { Home, Calendar, BookOpen, Briefcase, Users, MessageSquare, Settings, UserPlus, UserCircle } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Find Teammates', path: '/teammates', icon: UserPlus },
